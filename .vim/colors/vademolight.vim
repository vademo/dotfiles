...
let g:colors_name="vademo"

if exists("g:vademo_original")
    let s:vademo_original = g:vademo_original
else
...
" hi VisualNOS                     guibg=#FCB400
" hi Visual                        guibg=#FCB400
...
if &t_Co > 255
   if s:vademo_original == 1
      ...
      hi Normal       ctermfg=52 ctermbg=233
      hi CursorLine               ctermbg=234   cterm=none
      hi CursorLineNr ctermfg=202               cterm=none
   endif
   hi Boolean         ctermfg=25
   hi Character       ctermfg=144
   hi Number          ctermfg=234
   ...
   hi Exception       ctermfg=28               cterm=bold
   hi Float           ctermfg=160
   ...
   hi PreCondit       ctermfg=28               cterm=bold
   ...
   " marks column
   hi SignColumn      ctermfg=28 ctermbg=256
   ...
   hi VertSplit       ctermfg=244 ctermbg=250   cterm=bold
